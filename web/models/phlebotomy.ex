defmodule Cmsv1.Phlebotomy do
  ...
  def changeset(struct, params \\ %{}) do
    struct
    |> cast(params, [:hiv_status, :hiv_date, :hepc_status, :hepc_date, :hepa_status, :hepa_date, :hepb_status, :hepb_date, :ref_status, :ref_date, :ref_to])
    |> validate_required([:hiv_status, :hiv_date, :hepc_status, :hepc_date, :hepa_status, :hepa_date, :hepb_status, :hepb_date, :ref_status, :ref_date, :ref_to])
